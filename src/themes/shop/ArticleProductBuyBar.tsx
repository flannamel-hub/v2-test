...
export function ArticleProductBuyBar({
  ...
  const buyClass = isStandard
    ...
    : 'group relative inline-flex h-[2.9em] w-[8.5em] items-center justify-center gap-2 rounded-[11px] border-2 border-[#3654ff] bg-transparent text-base font-bold leading-none text-[#111827] transition-all duration-[600ms] ease-out hover:bg-[#3654ff] hover:text-white dark:text-white'
