    ...
    >
      <span className="tweet-vending-btn__ring">
        <span className="tweet-vending-btn__ring-blur">
          <span className="tweet-vending-btn__ring-gradient" />
        </span>
      </span>

      <span className="tweet-vending-btn__glow-track">
        <span className="tweet-vending-btn__glow-bar" />
      </span>

      <span className="tweet-vending-btn__inner">
        <span className="tweet-vending-btn__icon-wrap">
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
            ...
            className="tweet-vending-btn__star"
            aria-hidden
          >
            <path
